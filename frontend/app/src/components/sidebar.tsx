...
//   <div className="flex items-center gap-x-1.5 group cursor-pointer w-full">
//     <div className="w-1 h-8 bg-transparent rounded-xl relative overflow-hidden">
//       <div className="absolute top-0 left-0 w-full h-full bg-red-600 transition-all duration-300 group-hover:translate-y-0"></div>
//     </div>
//     <div className="flex items-center pl-2 space-x-2 w-full text-white text-sm transition-all duration-200 rounded group-hover:bg-white/10">
//       {icon}
//       <span>{title}</span>
//     </div>
//   </div>
...
//       {/* メニューアイテム */}
//       <div className="w-full pr-3 flex flex-col gap-y-1 text-gray-500">
//         <div className="pl-4 text-gray-400/60 text-xs uppercase">Menu</div>
//         <MenuItem icon={<HomeIcon />} title="Home" />
//         {/* <MenuItem icon={<DiscoveryIcon />} title="Discovery" /> */}
//         <MenuItem icon={<FriendsIcon />} title="Friends" />
//         {/* <MenuItem icon={<ComingSoonIcon />} title="Coming soon" /> */}
//       </div>

//       {/* プロファイルセクション */}
//       <div className="w-full pr-3 flex flex-col gap-y-1 text-gray-500">
//         <div className="pl-4 text-gray-400/60 text-xs uppercase">Profile</div>
//         {/* <MenuItem icon={<EditProfileIcon />} title="edit profile" />
